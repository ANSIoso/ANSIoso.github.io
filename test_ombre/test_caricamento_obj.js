...
async function main() {
	...
	function drawScene(projectionMatrix, cameraMatrix, cameraPosition, programInfo) {
		...
		u_world = m4.translation(settings.posX, settings.posY, settings.posY);
	...
	function render(time) {
		...
		drawScene(projection, camera, cameraPosition, meshProgramInfo);
